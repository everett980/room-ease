...
const functions = {
    getAllData() {
        ...
        return fetch(options.uri).then(res => res.json())
    },
    getAllRooms() {
    	const options = {
	...
	deleteATask(roomIndex, taskId) {
    	const deleteATaskRef = new Firebase(`https://room-ease.firebaseio.com/rooms/${roomIndex}/monthlyTasks/${taskId}`);
    	return deleteATaskRef.remove()
	},
